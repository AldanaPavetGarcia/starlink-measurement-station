...
| **is_obstructed** | BOOLEAN | S |  | TRUE si `obstructionStats.fractionObstructed > 0` en el momento de la medición. El firmware no expone un booleano `currently_obstructed` (confirmado ausente 12/08/2026); se deriva de la fracción continua de muestras recientes obstruidas con umbral bajo (>0), misma semántica de alerta temprana. NULL si no disponible. | false | RF-03 |
