...
El siguiente grafo muestra las relaciones de dependencia entre las 19 decisiones documentadas. Una flecha ADR-X → ADR-Y indica que ADR-Y depende de la decisión tomada en ADR-X.
