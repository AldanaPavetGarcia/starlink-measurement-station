...
def payload_aleatorio(rng: random.Random):
    ...
    return payload_valido(
        ...
        metrics={
            ...
            "boresight_azimuth_deg": rng.choice([None, rng.uniform(0, 360)]),
            "boresight_elevation_deg": rng.choice([None, rng.uniform(0, 90)]),
            "desired_boresight_azimuth_deg": rng.choice([None, rng.uniform(0, 360)]),
...
@pytest.mark.parametrize("campo,valor_invalido", [
    ...
    ("boresight_azimuth_deg", -0.01),
    ("boresight_azimuth_deg", 360.01),
